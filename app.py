...
st.write('Klíč získáte zdarma zde: '+'https://developer.mapy.cz/account/projects')
...
if st.button("A jedem!",use_container_width=True):
    if api_key is None:
        ...
        st.text("Některé budovy mohou mít i několik adresních míst...")
